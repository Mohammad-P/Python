...
calculate_sorted_averages('*\Averages.csv', '*\Averages_sorted.csv')
calculate_three_best('*\Averages_sorted.csv','*\Three_best.csv')
calculate_three_worst('*\Averages_sorted.csv','*\Three_worst.csv')
calculate_average_of_averages('*\Averages.csv', '*\Total_Averages.csv')
